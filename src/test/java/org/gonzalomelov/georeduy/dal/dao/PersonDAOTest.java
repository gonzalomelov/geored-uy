...
public class PersonDAOTest {
	...
	public static Archive<?> createDeployment(){
        JavaArchive jar = ShrinkWrap.create(JavaArchive.class,"PersonDAOTest.jar")
        	...
        	.addPackage(org.gonzalomelov.georeduy.dal.dao.interfaces.GenericDAO.class.getPackage())
        	.addPackage(org.gonzalomelov.georeduy.dal.dao.jpa.JPAAbstractDAO.class.getPackage())
